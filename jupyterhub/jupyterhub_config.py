...
#c.LocalGitHubOAuthenticator.oauth_callback_url = 'https://titans.hep.caltech.edu/hub/oauth_callback'
...
print("callbackurl", c.GitHubOAuthenticator.oauth_callback_url)

# Docker spawner
#from dockerspawner import DockerSpawner
# c.DockerSpawner.tls_ca = "/etc/docker/ca.pem"
# c.DockerSpawner.tls_cert = "/etc/letsencrypt/live/titans.hep.caltech.edu/fullchain.pem"
# c.DockerSpawner.tls_key = "/etc/letsencrypt/live/titans.hep.caltech.edu/privkey.pem"
#
import os
#os.environ["DOCKER_HOST"] = ":2375"
#c.JupyterHub.spawner_class = 'dockerspawner.SystemUserSpawner'
c.JupyterHub.spawner_class = 'dockerspawner.DockerSpawner'
c.DockerSpawner.use_docker_client_env = True
# tell containers to listen on all IPs
### [W 2017-11-03 06:08:54.632 JupyterHub app:398] JupyterHub.proxy_api_ip is deprecated in JupyterHub 0.8, use ConfigurableHTTPProxy.api_url
c.JupyterHub.proxy_api_ip = '0.0.0.0'
#c.ConfigurableHTTPProxy.api_url = '0.0.0.0'

### [W 2017-11-03 06:08:54.778 JupyterHub dockerspawner:84] DockerSpawner.container_ip is deprecated in dockerspawner-0.9.  Use DockerSpawner.host_ip to specify the host ip that is forwarded to the container
c.DockerSpawner.container_ip = '0.0.0.0'
#c.DockerSpawner.container_ip = '10.3.10.2:2377'
#c.DockerSpawner.host_ip = '0.0.0.0'
#c.DockerSpawner.container_ip = '131.215.207.60'
...
## trying with
##root@ibanks:~# docker network create --driver overlay jupyterhub
#c.JupyterHub.hub_ip = '0.0.0.0'
#c.DockerSpawner.hub_ip_connect = '10.3.10.2:2377'
#c.DockerSpawner.network_name = 'jupyterhub'

print('hub_ip_connect', c.DockerSpawner.hub_ip_connect)
...
#
# c.JupyterHub.hub_ip = '127.17.0.1'
# DockerSpawner.hub_ip_connect = '127.17.0.1'
...
c.DockerSpawner.volumes = { '/bigdata/tutorial' : '/tutorial'}
c.DockerSpawner.read_only_volumes = { '/bigdata/shared/' : '/inputdata'}


c.DockerSpawner.extra_create_kwargs.update({"volume_driver":"nvidia-docker"})
#c.DockerSpawner.read_only_volumes.update({"nvidia_driver_375.39":"/usr/local/nvidia"})
c.DockerSpawner.read_only_volumes.update({"nvidia_driver_384.90":"/usr/local/nvidia"})
c.DockerSpawner.extra_host_config.update({ "devices":["/dev/nvidiactl","/dev/nvidia-uvm","/dev/nvidia-uvm-tools","/dev/nvidia0","/dev/nvidia1","/dev/nvidia2","/dev/nvidia3","/dev/nvidia4","/dev/nvidia5","/dev/nvidia6","/dev/nvidia7"] })
...
#c.DockerSpawner.image = 'caltechcms/kerasjupyterhub'
#c.DockerSpawner.container_image = 'jupyterhub/singleuser'
c.DockerSpawner.container_image = 'caltechcms/kerasjupyterhub'
#c.DockerSpawner.container_image = 'caltechcms/kerasjh'
#c.DockerSpawner.container_image = 'caltechcms/kjh'
...
#c.JupyterHub.admin_users = {'dkcira','vlimant'}
c.Authenticator.admin_users = {'dkcira','vlimant', 'duanders'}
...
#  
#  Use with ssl_cert
#c.JupyterHub.ssl_cert = '/etc/jupyterhub/certificate.pem'
import glob
#c.JupyterHub.ssl_cert = '/etc/letsencrypt/live/passed-pawn-klmx.hep.caltech.edu/fullchain.pem'
c.JupyterHub.ssl_cert = glob.glob('/etc/letsencrypt/live/*/fullchain.pem')[0]

## Path to SSL key file for the public facing interface of the proxy
#  
#  Use with ssl_key
#c.JupyterHub.ssl_key = '/etc/letsencrypt/live/passed-pawn-klmx.hep.caltech.edu/privkey.pem'
c.JupyterHub.ssl_key = glob.glob('/etc/letsencrypt/live/*/privkey.pem')[0]
...
c.Authenticator.whitelist = {'dkcira','vlimant', 'duanders'}
