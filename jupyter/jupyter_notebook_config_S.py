...
c.NotebookApp.certfile = '/etc/grid-security/letsencrypt/cert.pem'
...
c.NotebookApp.keyfile = '/etc/grid-security/letsencrypt/privkey.pem'
...
c.NotebookApp.notebook_dir = u'/nfshome/'
